...
int main() {                       // main functions starting point
	...
	string firstname="Haseeb";        // string variable declaration and initialization by string value
	string lastname="Riaz";         // 2nd string variable declaration and initialization by string value
